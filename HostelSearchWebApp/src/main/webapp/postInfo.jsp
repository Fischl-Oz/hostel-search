...
<%--    <jsp:include page="header.jsp"/>--%>
    ...
    <!-- Search Start -->
    <div class="container-fluid bg-primary mb-5 wow fadeIn search-bar" data-wow-delay="0.1s" style="padding: 35px;">
        <div class="container">
            <div class="row g-2">
                <div class="col-md-10">
                    <div class="row g-2">
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <h2><%= post.getPostTitle()%></h2>
                        ...
                        <h4><%= hostel.getHostelName() %></h4>
                        <br/>
                        <h5><%= hostel.getHostelAddr()%></h5>
                        <%= post.getPostContent()%>
                        <br/>
                        <h5><%= hostel.getPrice() %>d</h5>
                    ...
                    <div class="row g-5 align-items-center">
                        ...
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                            <div class="mb-4">
                                ...
                                <p>Nhân viên chăm sóc khách hàng thường trực từ 9:00 sáng đến 10:00 tối các ngày trong
                                    tuần. Hãy liên lạc nếu bạn cần hỗ trợ.</p>
                            </div>
                            <a href="" class="btn btn-primary py-3 px-4 me-2"><i class="fa fa-phone-alt me-2"></i>Gọi
                                điện</a>
                            <a href="" class="btn btn-dark py-3 px-4"><i class="fa fa-envelope me-2"></i>Gửi tin
                                nhắn</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <p>Phản hồi ngay với chúng tôi khi bạn phát hiện có những nội dung được đăng tải không phù hợp, hoặc
                    không chính xác. Những phản hồi của bạn sẽ góp phần để website trở nên tốt hơn.</p>
            </div>
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item bg-light rounded p-3">
                    <div class="bg-white border rounded p-4">
                        <p>Những nội dung gây phản cảm là không được phép tồn tại trên trang web này. Nếu bạn phát hiện
                            bài đăng nào chứa thông tin phản cảm, hãy phản hồi ngay với tôi.</p>
                ...
                <div class="testimonial-item bg-light rounded p-3">
                    <div class="bg-white border rounded p-4">
                        <p>Tôi đi từ Bắc vào Nam, cập nhật mọi kiểu nhà trọ. Nếu bạn phát hiện có bài đăng nào là về một
                            nhà trọ không có thực, xin hãy phản hồi cho tôi.</p>
                        <div class="d-flex align-items-center">
                ...
                <div class="testimonial-item bg-light rounded p-3">
                    <div class="bg-white border rounded p-4">
                        <p>Chúng tôi đã cố gắng thiết kế trang web vừa đẹp mắt, vừa thân thiện với người dùng nhất có
                            thể. Nếu bạn cảm thấy có gì bất tiện khi sử dụng web, hãy liên hệ với tôi.</p>
                        <div class="d-flex align-items-center">
